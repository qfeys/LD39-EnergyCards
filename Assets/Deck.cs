...
static class Deck
{
    ...
    static Dictionary<Card, int> lib = new Dictionary<Card, int> {
            ...
            { new Card("trans_SPCD"     , Board.Regions.Road), 3 },
            { new Card("trans_pipe_oil" , Board.Regions.Road), 4 },
            { new Card("trans_pipe_gas" , Board.Regions.Road), 4 },
            { new Card("trans_rail"     , Board.Regions.city), 3 },
            { new Card("trans_term_coal", Board.Regions.port), 3 },
            { new Card("trans_term_oil" , Board.Regions.port), 3 },
            { new Card("trans_term_lng" , Board.Regions.port), 3 },
            { new Card("store_bat"      , Board.Regions.city | Board.Regions.desert), 4 },
            { new Card("store_oil"      , Board.Regions.city | Board.Regions.desert), 4 },
            { new Card("store_gas"      , Board.Regions.city | Board.Regions.desert), 4 },
            { new Card("store_fuel"     , Board.Regions.city | Board.Regions.port | Board.Regions.desert), 2 },
            { new Card("polit_resist"     , Board.Regions.city), 5 },
            { new Card("polit_fortify_fofu", Board.Regions.city), 2 },
            { new Card("polit_fortify_nuke", Board.Regions.city), 2 },
            { new Card("polit_fortify_wind", Board.Regions.city), 2 },
            { new Card("polit_fortify_solar", Board.Regions.city), 2 },
            { new Card("polit_extra_card" , Board.Regions.city), 2 },
