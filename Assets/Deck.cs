...
static class Deck
{
    ...
    static Dictionary<Card, int> lib = new Dictionary<Card, int> {
            ...
            { new Card("trans_HV"       , Board.Regions.Road), 4 },
            { new Card("trans_HVDC"     , Board.Regions.Road), 3 },
            ...
            { new Card("trans_rail"     , Board.Regions.city), 2 },
            { new Card("trans_term_coal", Board.Regions.port), 2 },
            { new Card("trans_term_oil" , Board.Regions.port), 2 },
            { new Card("trans_term_lng" , Board.Regions.port), 2 },
            { new Card("store_bat"      , Board.Regions.city | Board.Regions.desert), 3 },
            { new Card("store_oil"      , Board.Regions.city | Board.Regions.desert), 3 },
            { new Card("store_gas"      , Board.Regions.city | Board.Regions.desert), 3 },
